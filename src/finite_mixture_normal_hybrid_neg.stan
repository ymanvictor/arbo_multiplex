...
// parameters {
//   simplex[K] theta;           // mixing proportions
//   vector[K] raw_mu;           // unconstrained means, to be transformed
//   vector<lower=0>[K] sigma;   // scales of mixture components
// }
// 
// transformed parameters {
//   positive_ordered[K] mu;     // locations of mixture components, constrained
//   {
//     vector[K] sorted_raw_mu = sort_asc(raw_mu);  // Ensure ordering
//     for (k in 1:K) {
//       mu[k] = y_min + (y_max - y_min) * inv_logit(sorted_raw_mu[k]);
//     }
//   }
// }
...
// The generated quantities block below in addition to the log-likelihood of each observation 
// calculates the probability of each observation belonging to each component.
